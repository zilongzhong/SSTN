...
import sys
sys.path.append('/home/zilong/GANCRF')
...
from NetworksBlocks import SSNet_EAAE_KSC1, SSNet_AAEE_KSC1, SSNet_EAEA_KSC1, SSNet_AEAE_KSC1, SSNet_AAAA_KSC1, SSNet_EEEE_KSC1, SSNet_EEAA_KSC1,  SSRN, SSAN, STN, CONV, SPAN, ACONV1, ACONV2
...
parser.add_argument('--msize', type=int, default=13, help='channel size of mask')
...
parser.add_argument('--phi', type=str, default='EAAE', help='sequential order of network')
...
args.save = 'KSC-train-model-msize{}-gpu3-{}-arch-{}-{}-lr{}'.format(args.msize ,args.model, args.phi, time.strftime("%Y%m%d-%H%M%S"), args.learning_rate)
...
if args.model == 'SSTN':
    if args.phi == 'EAAE':
        net = SSNet_EAAE_KSC1(msize=args.msize)
    elif args.phi == 'AAEE':
        net = SSNet_AAEE_KSC1(msize=args.msize)
    elif args.phi == 'AEAE':
        net = SSNet_AEAE_KSC1(msize=args.msize)
    elif args.phi == 'EAEA':
        net = SSNet_EAEA_KSC1(msize=args.msize)
    elif args.phi == 'AAAA':
        net = SSNet_AAAA_KSC1(msize=args.msize)
    elif args.phi == 'EEEE':
        net = SSNet_EEEE_KSC1(msize=args.msize)
    elif args.phi == 'EEAA':
        net = SSNet_EEAA_KSC1(msize=args.msize)
elif args.model == 'SSRN':
    net = SSRN(num_classes=13, k=85)
elif args.model == 'SSAN':
    net = SSAN(num_classes=13, k=85)
elif args.model == 'STN':
    net = STN(num_classes=13, in_size=176)
elif args.model == 'CONV':
    net = CONV(num_classes=13, in_size=176)
elif args.model == 'ACONV1':
    net = ACONV1(num_classes=13, in_size=176)
elif args.model == 'ACONV2':
    net = ACONV2(num_classes=13, in_size=176)
elif args.model == 'SPAN':
    net = SPAN(num_classes=13, in_size=176)
else:
...
SAVE_PATH3 = args.save + '/' + str(args.model) + '_seed' + str(args.seed) + '_msize' + str(args.msize) + '.pth' 
...
if args.model == 'SSTN':
    if args.phi == 'EAAE':
        trained_net = SSNet_EAAE_KSC1(msize=args.msize)
    elif args.phi == 'AAEE':
        trained_net = SSNet_AAEE_KSC1(msize=args.msize)
    elif args.phi == 'AEAE':
        trained_net = SSNet_AEAE_KSC1(msize=args.msize)
    elif args.phi == 'EAEA':
        trained_net = SSNet_EAEA_KSC1(msize=args.msize)
    elif args.phi == 'EEEE':
        trained_net = SSNet_EEEE_KSC1(msize=args.msize)
    elif args.phi == 'AAAA':
        trained_net = SSNet_AAAA_KSC1(msize=args.msize)
    elif args.phi == 'EEAA':
        trained_net = SSNet_EEAA_KSC1(msize=args.msize)
elif args.model == 'SSRN':
    trained_net = SSRN(num_classes=13, k=85)
elif args.model == 'SSAN':
    trained_net = SSAN(num_classes=13, k=85)
elif args.model == 'STN':
    trained_net = STN(num_classes=13, in_size=176)
elif args.model == 'CONV':
    trained_net = CONV(num_classes=13, in_size=176)
elif args.model == 'ACONV1':
    trained_net = ACONV1(num_classes=13, in_size=176)
elif args.model == 'ACONV2':
    trained_net = ACONV2(num_classes=13, in_size=176)
elif args.model == 'SPAN':
    trained_net = SPAN(num_classes=13, in_size=176)
else:
...
plt.imshow(y_pred)
plt.axis('off')
fig_path = './saved_figures/' + str(args.model) + '_seed' + str(args.seed) + '.png'
