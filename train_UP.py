...
from NetworksBlocks import SSNet_EAAE_UP, SSNet_AAEE_UP, SSNet_EAEA_UP, SSNet_AEAE_UP, SSNet_AAAA_UP, SSNet_EEEE_UP, SSNet_EEAA_UP, SSRN, SSAN, STN, CONV, SPAN, ACONV1
...
args.save = 'UP-train-seed2-model-{}-arch-{}-{}-lr{}'.format(args.model, args.phi, time.strftime("%Y%m%d-%H%M%S"), args.learning_rate)
...
if args.model == 'SSTN':
    if args.phi == 'EAAE':
        trained_net = SSNet_EAAE_UP()
    elif args.phi == 'AAEE':
        trained_net = SSNet_AAEE_UP()
    elif args.phi == 'AEAE':
        trained_net = SSNet_AEAE_UP()
    elif args.phi == 'EAEA':
        trained_net = SSNet_EAEA_UP()
    elif args.phi == 'EEEE':
        trained_net = SSNet_EEEE_UP()
    elif args.phi == 'AAAA':
        trained_net = SSNet_AAAA_UP()
    elif args.phi == 'EEAA':
        trained_net = SSNet_EEAA_UP()
elif args.model == 'SSRN':
    trained_net = SSRN()
elif args.model == 'SSAN':
    trained_net = SSAN()
