...
from NetworksBlocks import SSNet_EAAE_KSC, SSNet_AAEE_KSC, SSNet_EAEA_KSC, SSNet_AEAE_KSC, SSNet_AAAA_KSC, SSNet_EEEE_KSC, SSNet_EEAA_KSC,  SSRN, SSAN, STN, CONV, SPAN, ACONV1, ACONV2
...
parser.add_argument('--l1', type=str, default='noKSC', help='choice of first layer in tranformer unit')
...
args.save = 'KSC-l1{}-set-seed{}-model-{}-arch-{}-{}-lr{}'.format(args.l1, args.seed, args.model, args.phi, time.strftime("%Y%m%d-%H%M%S"), args.learning_rate)
...
if args.model == 'SSTN':
    if args.phi == 'EAAE':
        net = SSNet_EAAE_KSC(l1=args.l1)
    elif args.phi == 'AAEE':
        net = SSNet_AAEE_KSC(l1=args.l1)
    elif args.phi == 'AEAE':
        net = SSNet_AEAE_KSC(l1=args.l1)
    elif args.phi == 'EAEA':
        net = SSNet_EAEA_KSC(l1=args.l1)
    elif args.phi == 'AAAA':
        net = SSNet_AAAA_KSC(l1=args.l1)
    elif args.phi == 'EEEE':
        net = SSNet_EEEE_KSC(l1=args.l1)
    elif args.phi == 'EEAA':
        net = SSNet_EEAA_KSC(l1=args.l1)
...
SAVE_PATH3 = args.save + '/' + str(args.model) + '_seed' + str(args.seed) + time.strftime("%Y%m%d-%H%M%S")+ '.pth' 
...
if args.model == 'SSTN':
    if args.phi == 'EAAE':
        trained_net = SSNet_EAAE_KSC(l1=args.l1)
    elif args.phi == 'AAEE':
        trained_net = SSNet_AAEE_KSC(l1=args.l1)
    elif args.phi == 'AEAE':
        trained_net = SSNet_AEAE_KSC(l1=args.l1)
    elif args.phi == 'EAEA':
        trained_net = SSNet_EAEA_KSC(l1=args.l1)
    elif args.phi == 'EEEE':
        trained_net = SSNet_EEEE_KSC(l1=args.l1)
    elif args.phi == 'AAAA':
        trained_net = SSNet_AAAA_KSC(l1=args.l1)
    elif args.phi == 'EEAA':
        trained_net = SSNet_EEAA_KSC(l1=args.l1)
elif args.model == 'SSRN':
